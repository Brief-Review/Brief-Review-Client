  ...
  return (
    <div className={`w-full flex flex-col ${className}`}>
      ...
      <div className="grid md:grid-cols-6  gap-4 ">
        <div className=" flex flex-col col-span-6 md:col-span-4  shadow-md rounded p-8 gap-4">
          <h2>Descripción:</h2>
          <p>
            {brief.Description}
          </p>
          ...
          <div className="flex gap-4">
            <div className="shadow-md w-full md:w-[30%] p-4 aspect-video  rounded relative">
        ...
        <div className="col-span-6 md:col-span-2 p-4 shadow-md rounded flex flex-col justify-between gap-4">
